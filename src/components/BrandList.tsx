  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="text-center mb-20">
        <p className="font-bold mx-2">WHAT WE ARE LOOKING FOR</p>
        <h1 className="text-3xl my-2 font-bold text-gray-600">
          BRANDS WITH POTENTIAL TO BECOME LEADING <br /> HOUSEHOLD NAMES</h1>
        <div className="flex mt-6 justify-center">
          <div className="w-16 h-1 rounded-full bg-primeColor inline-flex"></div>
        </div>
      </div>
      <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
        <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
          ...
          <div className="flex-grow">
            <h2 className="text-gray-900 text-lg title-font font-medium mb-3">High Quality Products</h2>
